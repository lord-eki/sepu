      ...
      <div class="relative max-w-7xl mx-auto px-6 py-16 lg:py-24 space-y-20">
        ...
        <section class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="group rounded-2xl bg-white/80 dark:bg-gray-800/60 backdrop-blur-lg
                     ...
                     shadow-md hover:shadow-xl hover:-translate-y-2
                     transition-all duration-500">
            <MapPin class="w-8 h-8 text-orange-500 mx-auto mb-4 group-hover:scale-110 transition" />
            <h3 class="font-semibold text-gray-900 dark:text-white text-lg">Location</h3>
            <p class="text-gray-600 dark:text-gray-300 text-sm mt-2">
              SEPU SACCO HQ, Nairobi, Kenya
            </p>
          </div>
          ...
          <div class="group rounded-2xl bg-white/80 dark:bg-gray-800/60 backdrop-blur-lg
                     ...
                     shadow-md hover:shadow-xl hover:-translate-y-2
                     transition-all duration-500">
            <Clock class="w-8 h-8 text-orange-500 mx-auto mb-4 group-hover:scale-110 transition" />
            <h3 class="font-semibold text-gray-900 dark:text-white text-lg">Working Hours</h3>
            <p class="text-gray-600 dark:text-gray-300 text-sm mt-2">
        ...
        <!-- Contact Form -->
        <section class="rounded-3xl bg-white/80 dark:bg-gray-800/60 backdrop-blur-xl
                        border border-gray-200 dark:border-gray-700 shadow-xl p-10">

          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-8 text-center">
            Send Us a Message
          </h2>

          <form class="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div>
        ...
        <!-- Map -->
        <section class="rounded-3xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700">
          <iframe class="w-full h-96" frameborder="0" allowfullscreen
