        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    <Label for="name" class="text-gray-900 dark:text-gray-100">Full name</Label>
                    <Input
                        id="name"
                        type="text"
                        required
                ...
                <!-- Email -->
                <div class="grid gap-2">
                    <Label for="email" class="text-gray-900 dark:text-gray-100">Email address</Label>
                    <Input
                        id="email"
                        type="email"
                        required
                ...
                <!-- Phone -->
                <div class="grid gap-2">
                    <Label for="phone" class="text-gray-900 dark:text-gray-100">Phone number</Label>
                ...
                <!-- Confirm Password -->
                <div class="grid gap-2">
                    <Label for="password_confirmation" class="text-gray-900 dark:text-gray-100">
                        Confirm password
                    </Label>
                    <Input
                ...
                <Button
                    type="submit"
                    class="mt-2 hover:cursor-pointer w-full"
                    tabindex="6"
