<template>
  <AppLayout :breadcrumbs="[
    ...
    { title: account.account_type === 'share_capital' ? 'Add Share Capital' : 'Deposit' }
  ]">
      ...
      <div class="relative flex flex-wrap sm:flex-row justify-between items-start sm:items-center gap-4 text-white">
        <div>
          <h2 class="text-xl sm:text-2xl font-bold tracking-tight">
            {{ account.account_type === 'share_capital' ? 'Add Share Capital' : 'Deposit Funds' }}
          </h2>
    ...
    <!-- MAIN FORM -->
    <div class="pb-10 pt-5 px-[5%] bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <div class="max-w-4xl mx-auto bg-white/80 backdrop-blur-xl border border-slate-200 rounded-3xl shadow-2xl p-10">
        ...
        <div class="grid sm:grid-cols-4 gap-6 mb-10">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-[#0B2B40]">
        ...
        <form
          ...
          class="space-y-8"
          :class="{ 'opacity-50 pointer-events-none': depositLocked }"
        >
