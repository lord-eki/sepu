  ...
  <AppLayout :breadcrumbs="[{ title: 'Loan Calculator' }]">
    ...
    formatNumber(selectedProduct.max_amount) }}
        ...
        <div v-if="calculation && showSchedule" ref="scheduleSection"
          ...
          <!--  Enable vertical + horizontal scrolling -->
          <div class="overflow-x-auto max-h-[500px] overflow-y-auto">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="payment in calculation.amortization_schedule" :key="payment.payment_number"
...
export default {
  ...
  setup(props) {
    ...
    const scheduleSection = ref < HTMLElement | null > (null)
