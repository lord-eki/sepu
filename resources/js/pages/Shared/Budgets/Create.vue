  ...
  <AppLayout :breadcrumbs="[
    ...
    <div class="flex pt-4 gap-2 items-center px-4">
      <Link :href="route('budgets.index')"
        class="text-blue-900 py-1 px-1 bg-slate-300 rounded-full flex hover:text-orange-600 w-fit transition">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                  ...
                  <textarea id="description" v-model="form.description" rows="3"
                    class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-600 focus:border-blue-600"></textarea>
          ...
          <div class="bg-white rounded-2xl shadow border border-gray-100 overflow-hidden">
            ...
            <div class="p-6">
              ...
              <div v-if="form.budget_items.length === 0" class="text-center py-8">
                ...
                <p class="text-gray-500">No budget items yet. Click <span class="font-medium text-orange-600">"Add
                ...
                <table class="min-w-full border border-gray-200 text-sm">
                  ...
                  <tbody>
                    <tr v-for="(item, index) in form.budget_items" :key="index"
                      ...
                      <td class="px-3 py-2 text-right">
                        <input v-model.number="item.budgeted_amount" type="number" step="0.01" min="0"
                          @input="calculateTotalBudget"
                          class="w-full text-right border-gray-300 rounded-lg p-1 focus:ring-blue-600 focus:border-blue-600"
                          required />
                      </td>
                      <td class="px-3 py-2 text-center">
                        <button type="button" @click="removeBudgetItem(index)" class="text-red-600 hover:text-red-800"
                          title="Remove row">
                          ✕
                        </button>
                      </td>
                  ...
                  <tfoot class="bg-gray-50 font-semibold">
                    <tr>
                      ...
                      <td class="px-3 py-2 text-right text-blue-900">{{ formatCurrency(form.total_budget) }}</td>
                      <td></td>
                    </tr>
                  </tfoot>
              ...
              <div v-if="form.budget_items.length > 0" class="mt-6 border-t border-gray-200 pt-4">
                <div class="flex justify-between items-center">
                  <div>
                    <label for="total_budget" class="block text-sm font-medium text-gray-700">Total Budget
                      Amount</label>
