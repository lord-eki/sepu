<template>
  <AppLayout :breadcrumbs="[{ title: 'Budgets', href: '/budgets' }]">
    ...
    <!-- Page Header -->
    <div
      class="bg-gradient-to-r from-[#0a2342] to-orange-500 border-l-4 border-orange-500 rounded-xl shadow p-5 mx-5 mt-6 flex flex-col md:flex-row md:items-center md:justify-between"
    >
      <div>
        <h2 class="text-2xl font-bold text-white">Budget Management</h2>
        <p class="text-blue-100 text-sm mt-1">Manage, monitor, and control your financial budgets</p>
      </div>

      <Link
        :href="route('budgets.create')"
        class="mt-4 md:mt-0 inline-flex items-center gap-2 bg-white text-[#0a2342] font-medium text-sm px-5 py-2 w-fit rounded-full shadow hover:bg-orange-50 transition"
      >
          ...
          <div
            v-for="card in [
              ...
              },
              {
                ...
                color: 'from-[#0a2342] to-blue-800',
                icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2',
              },
            ]"
            :key="card.label"
            class="bg-white rounded-2xl border border-gray-100 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 p-6"
          >
            <div class="flex items-center gap-4">
              <div
                class="p-3 rounded-full bg-gradient-to-br"
                :class="card.color"
              >
            ...
            <div class="flex flex-col sm:flex-row gap-3 flex-1">
              ...
              <div class="relative w-full sm:w-64">
                <input
                  ...
                  class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-full text-sm focus:border-orange-500 focus:ring focus:ring-orange-100"
                  @input="filterBudgets"
                />
              ...
              <select
                ...
                class="rounded-full border border-gray-300 text-sm px-4 py-2 focus:border-orange-500 focus:ring focus:ring-orange-100"
              >
            ...
            <table class="min-w-full divide-y divide-gray-100 text-sm">
              ...
              <tbody class="divide-y divide-gray-100">
                ...
                >
                  ...
                  <td class="px-6 py-4 font-semibold text-[#0a2342]">{{ formatCurrency(budget.total_budget) }}</td>
                  <td class="px-6 py-4">
                    <span
...
const filterBudgets = () => {
  router.get(
    route('budgets.index'),
    { search: search.value, status: statusFilter.value, year: yearFilter.value },
