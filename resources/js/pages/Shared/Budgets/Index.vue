    ...
    'M12 16c-1.11 0-2.08-.402-2.599-1'
            ...
            <div class="flex items-center space-x-4">
              ...
              <div>
                ...
                <p class="text-base font-semibold text-blue-900">{{ card.value }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 flex-1">
              ...
              <div class="relative w-full sm:w-64">
                <input v-model="search" type="text" placeholder="Search budgets..."
                  class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm focus:border-blue-600 focus:ring focus:ring-blue-200"
                  @input="filterBudgets" />
              ...
              <select v-model="statusFilter" @change="filterBudgets"
                class="rounded-lg border-gray-300 text-sm px-3 py-2 shadow-sm focus:border-blue-600 focus:ring focus:ring-blue-200">
            ...
            <Link :href="route('budgets.create')"
              class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-orange-500 text-white text-sm font-medium hover:bg-orange-600 transition">
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 text-xs sm:text-sm">
              ...
              <tbody class="divide-y divide-gray-100">
                <tr v-for="budget in budgets.data" :key="budget.id" class="hover:bg-blue-50 transition">
                  ...
                  <td class="px-6 py-4 font-medium text-blue-900">{{ formatCurrency(budget.total_budget) }}</td>
                  <td class="px-6 py-4">
                  ...
                  <td class="px-6 py-4 text-right">
                    <div class="flex justify-end gap-3">
                      <Link :href="route('budgets.show', budget.id)" class="text-blue-700 hover:underline">View</Link>
