<template>
 ...
 <!-- Header Section -->
    <div class="flex flex-col sm:flex-row bg-[#0B2B40] rounded-lg p-4 justify-between items-start sm:items-center mb-6 mx-6 mt-5">
      <div class="flex items-start gap-4">
        ...
        <div>
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Loan ID: <span class="font-medium">{{ loan.loan_number }}</span></p>
        </div>
      </div>
    ...
    <!-- Loan Summary -->
    <div class="bg-white dark:bg-gray-800 shadow rounded-2xl p-6 mb-6 mx-5 border border-gray-100 dark:border-gray-700">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-2xl overflow-hidden">
      <!-- Header -->
      <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gradient-to-r from-white to-white/95 dark:from-[#0B2B40] dark:to-[#0B2B40]/95">
      ...
      <!-- Table Container -->
      <div class="relative w-full overflow-x-auto border border-gray-100 dark:border-gray-700 bg-white dark:bg-[#0B2B40]">
      ...
      <Dialog as="div" class="relative z-50" @close="showSelfRepaymentModal = false">
        ...
        >
          ...
          <div class="fixed inset-0 flex items-center justify-center p-4">
            <DialogPanel class="bg-white dark:bg-gray-800 w-full max-w-md rounded-2xl shadow-2xl p-6 space-y-4 border border-gray-100 dark:border-gray-700">
    ...
    <TransitionRoot as="template" :show="showPaymentModal">
      <Dialog as="div" class="relative z-10" @close="showPaymentModal = false">
        <TransitionChild as="template" enter="ease-out duration-300" enter-from-class="opacity-0" enter-to-class="opacity-100" leave="ease-in duration-200" leave-from-class="opacity-100" leave-to-class="opacity-0">
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
          <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <DialogPanel class="relative transform overflow-hidden rounded-xl bg-white dark:bg-gray-800 px-6 pb-6 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg border border-gray-100 dark:border-gray-700">
                  ...
                  <div class="flex flex-col items-center">
                    <div class="flex h-12 w-12 items-center justify-center rounded-full bg-[#E6F7FF]">
                      <svg class="h-6 w-6 text-[#0B2B40]" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v8m0 0v1m0-1c1.11 0 2.08-.402 2.599-1M12 8V7m0 1c-1.11 0-2.08.402-2.599 1" />
                      </svg>
                    </div>
