        ...
        <form @submit.prevent="submit" class="space-y-8">
          ...
          <div class="bg-white shadow-[0_3px_10px_rgb(0,0,0,0.1)] rounded-xl border">
            ...
            <div class="p-6 space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    class="w-full rounded-lg border-gray-300 focus:border-[#ff7a00] focus:ring-[#ff7a00]"
                  ...
                  <p v-if="$page.props.errors.voucher_type"
                ...
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    placeholder="0.00"
                    class="w-full rounded-lg border-gray-300 focus:border-[#ff7a00] focus:ring-[#ff7a00] pl-3"
                  />

                  <p v-if="$page.props.errors.amount"
                     class="text-red-600 text-sm mt-1">
              ...
              <div>
                ...
                <p v-if="$page.props.errors.purpose"
                   class="text-red-600 text-sm mt-1">{{ $page.props.errors.purpose }}</p>
              </div>
              ...
              <div>
                ...
                <p v-if="$page.props.errors.description"
                   class="text-red-600 text-sm mt-1">{{ $page.props.errors.description }}</p>
              </div>
          ...
          <div class="bg-white shadow-[0_3px_10px_rgb(0,0,0,0.1)] rounded-xl border">
            ...
            <div class="p-6">
              ...
              <!-- Upload Box -->
              <div class="border-2 border-dashed border-gray-300 p-6 text-center rounded-xl hover:bg-gray-50 transition">
              ...
              <div v-if="form.supporting_documents.length > 0" class="mt-4 space-y-3">
                ...
                <div v-for="(file, index) in form.supporting_documents"
                     :key="index"
          ...
          <div class="flex justify-end space-x-4 mt-6">
            ...
            >
              <svg v-if="processing" class="animate-spin h-4 w-4 mr-2 text-white" viewBox="0 0 24 24" fill="none">
                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
                <path class="opacity-75" fill="currentColor"
                      d="M4 12a8 8 0 018-8V0C5.38 0 0 5.38 0 12h4z"/>
              </svg>

              <span>{{ processing ? "Creating..." : "Create Voucher" }}</span>
            </button>
