  ...
  <AppLayout :breadcrumbs="[{ title: 'Dividends', href: '/dividends' }]">
    ...
    <div class="py-10">
      <div class="max-w-7xl mx-auto px-4 space-y-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            <div class="flex items-center space-x-4">
              <div
                :class="[card.color, 'w-10 h-10 rounded-xl flex items-center justify-center shadow-md']"
              >
        ...
        <!-- Filters + Actions -->
        <div
          class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-md p-6"
        >
          <div
            ...
            <div class="flex flex-wrap gap-3">
              ...
              >
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    d="M4 13l4-4 3 3 5-6a1 1 0 111.6 1.2l-6 7a1 1 0 01-1.4.1L8 11l-3.3 3.3a1 1 0 11-1.4-1.4z"
                  />
                </svg>
                Analytics
              </Link>
    ...
    <div
      v-if="processing"
      class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 dark:bg-black/70"
    >
      <div
    ...
    >
      <div
        class="bg-white dark:bg-gray-900 max-sm:mx-3 rounded-2xl shadow-lg max-w-md w-full p-6"
      >
        ...
        <div class="flex justify-end gap-3">
          ...
          >
            ...
            <span
              v-if="processing"
              class="ml-2 animate-spin border-2 border-white border-t-transparent rounded-full w-4 h-4"
            ></span>
          </button>
        </div>
      </div>
      ...
      >
        ...
        <div class="mb-4">
          ...
          <textarea
            ...
            rows="3"
            class="mt-1 block w-full border border-gray-300 dark:border-gray-700 rounded-lg p-2 dark:bg-gray-800 dark:text-gray-200"
          ></textarea>
        </div>
