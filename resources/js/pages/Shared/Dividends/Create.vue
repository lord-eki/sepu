<template>
  <AppLayout title="Calculate New Dividend">
    <template #header>
          ...
          <div class="flex">
            ...
            <div class="ml-3">
              ...
              <div class="mt-2 text-sm text-yellow-700">
                A dividend for {{ existingDividend.dividend_year }} already exists with status "{{ existingDividend.status }}".
          ...
          <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div class="bg-green-50 p-4 rounded-lg">
                ...
                <div class="text-2xl font-bold text-green-900">KSh {{ formatCurrency(form.total_profit || 0) }}</div>
              ...
              <div class="bg-purple-50 p-4 rounded-lg">
                ...
                <div class="text-2xl font-bold text-purple-900">KSh {{ formatCurrency(calculatedDividends) }}</div>
          ...
          <div class="p-6">
            ...
            <form @submit.prevent="submitForm">
              <div class="space-y-6">
                ...
                <div v-if="calculationSummary" class="bg-gray-50 rounded-lg p-4">
                  ...
                  <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                      ...
                      <div class="text-lg font-bold text-gray-900">KSh {{ formatCurrency(calculationSummary.total_dividends) }}</div>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div class="text-lg font-bold text-gray-900">KSh {{ formatCurrency(calculationSummary.average_dividend) }}</div>
                    </div>
                    <div>
                ...
                <div v-if="memberBreakdown && memberBreakdown.length > 0" class="bg-white border border-gray-200 rounded-lg">
                  <div class="p-4 border-b border-gray-200">
                    <h4 class="text-md font-medium text-gray-900">Member Dividend Breakdown (Preview)</h4>
                    <p class="text-sm text-gray-600">Showing first 10 members - all {{ memberBreakdown.length }} members will receive dividends</p>
                  </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                      <thead class="bg-gray-50">
                        <tr>
                          ...
                          <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Shares Balance</th>
                          <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Dividend Amount</th>
                        </tr>
                      </thead>
                ...
                <div class="flex items-center justify-between">
                  <Link :href="route('dividends.index')" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400">
                    Cancel
                  </Link>
