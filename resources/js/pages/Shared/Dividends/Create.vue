<template>
  <AppLayout :breadcrumbs="[
    ...
    <!-- PAGE TITLE -->
    <h2 class="font-semibold text-2xl sm:text-3xl px-4 sm:px-10 py-2 text-[#0A1A2F] dark:text-white">
        ...
        <div class="bg-white dark:bg-[#0a0f1a] shadow-lg rounded-xl border border-gray-100 dark:border-gray-700">
          <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <!-- PROFIT -->
              <div class="bg-orange-100 dark:bg-orange-900/40 p-5 rounded-xl border border-orange-200 dark:border-orange-700">
          ...
          <div class="p-6">
            ...
            <form @submit.prevent="submitForm" class="space-y-8">
              ...
              >
                ...
                <div
                  v-if="memberBreakdown.length > 10"
