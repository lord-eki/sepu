...
<template>
  <PublicLayout>
    ...
    <div
      class="max-w-5xl mx-auto px-3 sm:px-6 py-5 sm:py-10 space-y-10
             bg-gray-50 dark:bg-gray-900 transition-colors"
    >

      <!-- Header -->
      <div
        class="text-center bg-gradient-to-r from-blue-900 to-blue-800
               dark:from-gray-800 dark:to-gray-900
               p-8 rounded-3xl shadow-lg text-white"
      >
        <h1 class="text-3xl sm:text-4xl font-extrabold mb-2">Terms of Service</h1>
        <p class="text-sm sm:text-base text-gray-200 dark:text-gray-300 max-w-3xl mx-auto">
      ...
      <section
        class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800
               shadow-md rounded-2xl p-8 leading-relaxed
      ...
      <div class="space-y-10">
        <section
          ...
          :key="index"
          class="bg-white dark:bg-gray-900 shadow-md rounded-2xl p-8
                 border border-gray-100 dark:border-gray-800
                 transition-colors"
        >
          <div class="flex items-center gap-3 mb-4">
            <component :is="item.icon" class="w-6 h-6 text-orange-500" />
            <h2 class="text-xl font-semibold text-blue-900 dark:text-white">
              {{ item.title }}
            </h2>
          </div>

          <p class="text-gray-700 dark:text-gray-300 text-sm sm:text-base leading-relaxed mb-3">
            {{ item.intro }}
          </p>

          <ul
            v-if="item.points"
            class="list-disc ml-6 space-y-1 text-gray-600 dark:text-gray-400 text-sm sm:text-base"
          >
      ...
      <section
        class="bg-gradient-to-r from-blue-900 to-blue-800
               dark:from-gray-800 dark:to-gray-900
               text-white rounded-3xl shadow-lg p-10 space-y-4 transition-colors"
      >
        ...
        <p class="max-w-2xl mx-auto text-base text-gray-200 dark:text-gray-300">
          For any questions or clarifications regarding these terms, please reach out to us:
        </p>

        <ul class="text-sm sm:text-base space-y-2 text-gray-200 dark:text-gray-300">
          <li>
            Email:
            <a
              href="mailto:support@sepusacco.org"
      ...
      <!-- Footer Note -->
      <p class="text-xs text-center text-gray-500 dark:text-gray-400 italic mt-6">
