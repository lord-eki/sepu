            ...
            <form @submit.prevent="submit" class="bg-white shadow-lg rounded-xl p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input :value="form.account_code" type="text" readonly :class="[
        ...
        isGeneratingCode ? 'animate-pulse' : ''
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select v-model="form.account_type" :disabled="!!form.parent_account_id" :class="[
        ...
        form.parent_account_id ? 'bg-gray-50 text-gray-600 cursor-not-allowed' : ''
                    ...
                    <div>
                        ...
                        <div v-if="!showNewCategory" class="flex gap-2">
                            ...
                            <button type="button" @click="openNewCategory" title="Add new category"
                        ...
                        <div v-else class="border border-orange-300 rounded-lg p-3 bg-orange-50 space-y-2">
                            <div class="flex items-center justify-between mb-1">
                                <span
                                    class="flex items-center gap-1 text-xs font-semibold text-orange-700 uppercase tracking-wide">
                            ...
                            <input v-model="newCategoryLabel" type="text" placeholder="e.g. Prepaid Expenses"
                                :disabled="isSavingCategory" @keyup.enter="addCategory"
