    ...
    <div class="py-8">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div class="flex justify-between items-center">
          <h2 class="text-lg sm:text-xl font-bold text-gray-800">Members Management</h2>
          <Link
            v-if="$page.props.auth.user.role !== 'member'"
            :href="route('members.create')"
            class="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
          >
        ...
        <div 
          ...
          :key="member.id" 
          class="p-4 rounded-xl border mb-3 bg-white shadow-sm"
        >
              ...
              <tbody class="divide-y divide-gray-100 bg-white">
                ...
                >
                  ...
                  <td class="px-6 py-4 text-right space-x-3">
                    ...
                    <button
                      v-if="member.membership_status === 'active' && canManageStatus"
                      @click="updateStatus(member, 'deactivate')"
