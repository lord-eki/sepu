  ...
  <AppLayout :breadcrumbs="[{ title: 'Members', href: '/members' }]">
    ...
    <div ref="flashBox" class="mx-auto max-w-7xl px-4 pt-4 sm:px-6 lg:px-8">
      ...
      >
        <div
          v-if="flashMessage"
          class="flex items-start gap-3 rounded-2xl border px-4 py-4 shadow-lg backdrop-blur-xl"
          :class="
            flashType === 'success'
      ...
      <section class="mx-auto mt-8 max-w-7xl px-4 sm:hidden">
        ...
        >
          <div class="flex items-start justify-between gap-3">
            ...
            <span class="rounded-full px-2.5 py-1 text-xs font-semibold" :class="statusColors[member.membership_status]">
                ...
                >
                  ...
                  <td class="px-6 py-4 text-right">
                    <div class="flex justify-end gap-4 text-sm font-medium">
                      <Link :href="route('members.show', member.id)" class="text-blue-600 hover:underline dark:text-blue-400">
                        View
                      </Link>
                      <Link
                        v-if="$page.props.auth.user.role !== 'member'"
    ...
    <!-- Delete Modal -->
    <div v-if="showDeleteConfirm" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4 backdrop-blur-sm">
