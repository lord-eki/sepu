...
<template>
  ...
  >
    ...
    <div
      class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 px-4 py-5 sm:px-6 lg:px-8"
    >
     <!-- HEADER -->
<div
  class="relative overflow-visible rounded-[28px] bg-gradient-to-br from-[#0F172A] via-[#132F57] to-[#1E3A8A] p-5 sm:p-7 shadow-xl"
>
  <!-- glow -->
  <div
    class="absolute -top-20 -right-20 h-72 w-72 rounded-full bg-blue-400/20 blur-3xl"
  ></div>
  ...
  <div class="relative z-10">
    ...
    >
      ...
      <div>
        ...
        <h1
          class="mt-4 text-xl font-bold tracking-tight text-white sm:text-2xl"
        >
          Welcome,
      ...
      >
        ...
        >
          <div>
            <p
              class="text-[11px] uppercase tracking-wider text-slate-300"
            >
              Total Balance
            </p>

            <div
              class="mt-1 flex items-center gap-2 text-white"
            >
              <h2
              ...
              <div
                class="hidden items-center gap-1 text-xs text-emerald-300 sm:flex"
              >
        ...
        <div class="relative">
          ...
          <div
            ...
            class="fixed inset-0 z-[999] flex items-start justify-center px-4 pt-20"
          >
            <!-- Backdrop -->
            <div
            ...
            <!-- Notification Box -->
            <div
              class="relative w-full max-w-md rounded-2xl border border-slate-200 bg-white shadow-2xl"
            >
              <!-- Header -->
              <div
      ...
      >
        <Card
          ...
          :key="stat.title"
          class="rounded-[28px] border-0 bg-white shadow-sm transition-all duration-300 hover:shadow-xl"
        >
          <CardContent class="p-6">
            <div class="flex items-start justify-between">
              <div>
                ...
                <h3
                  class="mt-3 text-xl font-bold tracking-tight text-slate-900"
                >
      ...
      <section class="mt-10">
        ...
        >
          ...
          >
              ...
              >
                <CardContent class="p-6">
                  <div class="flex items-start justify-between">
                    ...
                    <Badge
                      class="rounded-full bg-orange-100 px-4 py-1 text-orange-700"
                    >
                      {{
                        fmtMoney(
            ...
            <div
              v-else
              class="rounded-[32px] border border-dashed border-slate-300 bg-white p-12 text-center"
            >
              <div
              ...
              <p
                class="mx-auto max-sm:text-sm mt-2 max-w-md text-slate-500"
              >
                ...
                <table class="w-full text-sm">
                  <thead class="bg-slate-50">
                    <tr class="text-slate-500">
                      <th
                        class="p-4 text-left font-medium"
                      >
                        Date
                      </th>
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td
                        class="p-4 text-right font-semibold text-slate-800"
                      >
                        {{ fmtMoney(t.amount) }}
                      </td>
