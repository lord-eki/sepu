            ...
            <div class="relative">
              ...
              <div v-if="showNotifications"
                ...
                <ul class="max-h-60 overflow-y-auto divide-y divide-gray-200">
                  <li v-for="n in notifications" :key="n.id" class="p-3 text-sm text-gray-700 hover:bg-blue-50">
            ...
            <TabsContent value="transactions" class="mt-6">
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3">
                ...
                <div class="w-full sm:w-64">
                  <Input v-model="txFilter" placeholder="Filter by type or amount"
                    class="border-blue-300 focus:ring-blue-600" />
                </div>
              </div>
